...
INSERT INTO `offers` (`offer_id`,location,`duration`,`stars`,`transportation`,`cost`) VALUES
 (20,'cairo',5,4,'Superjet',1350);
...
INSERT INTO `special_offers` (`sp_offer_id`,location,`duration`,`stars`,`transportation`,`cost`) VALUES
